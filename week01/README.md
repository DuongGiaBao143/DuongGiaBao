<<<<<<< HEAD
# Tuần 1 — Toán học trong AI

- **Buổi 1:** Khai giảng & Đại số tuyến tính cho AI
- **Buổi 2:** Xác suất thống kê cho AI

Đặt bài làm của tuần này vào thư mục này (`.ipynb` hoặc `.py`).
=======
...
>>>>>>> d992cf4bc0e179c821a1f1c6a20fd90307a91990
